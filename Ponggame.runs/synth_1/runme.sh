...
HD_PWD='C:/Users/Sawaphob Chavana/Desktop/ponggame_finalproject/Ponggame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z80_tester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z80_tester.tcl
